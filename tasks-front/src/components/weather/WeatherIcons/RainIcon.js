...
const RainIcon = (props) => (
  <svg
    style={props.style} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
    <defs>
        ...
        <linearGradient id="c" x1="1436.71" y1="-1137" x2="1454.86" y2="-1089.72" gradientTransform="translate(-1189.32 1354.33) rotate(-9)" xlinkHref="#b"/>
        <linearGradient id="d" x1="1492.12" y1="-1129.34" x2="1510.27" y2="-1082.06" gradientTransform="translate(-1189.24 1355.43) rotate(-9)" xlinkHref="#b"/>
    ...
    <use width="129" height="57" transform="translate(191.5 343.5)" xlinkHref="#f"/>
</svg>
);
